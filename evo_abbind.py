...
def train_one_epoch(args, MERF_model, optimizer, epoch, n_epoch, train_loader, loss_history, device,
					is_parallel, docking_folder, transform, agent_select, global_step, wt_energy):
...
if __name__ == '__main__':
	...
	docking_folder = "/home/lfj/projects_dir/Antibody_Mutation/docking/Abbind_evo_3/"
	
	# read in files and start train loop
	
	# train_path = 'data/ABbind/AB-Bind_evo_v3.csv'
	# train_path = 'data/ABbind/AB-Bind_evo_v3_9of20.csv'
	...
	for i in range(len(train_df)):
		...
		# old_docking_energy = train_df['docking_energy'].iloc[0]
		# if old_docking_energy != wt_energy:
		# 	wt_energy = float(old_docking_energy)
		
		# total_epoch = 30  # 2 & 3 points
		total_epoch = 50  # 4 points
