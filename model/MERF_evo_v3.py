...
class MERF(BaseMERF):
    """MERF v6 with a small evolution-only site/action policy adapter."""
    ...
    def get_candidate_log_probs(self, binary_log_probs, dataset):
        ...
        return candidate_scores + self.candidate_score_bias[:n_candidates].to(candidate_scores.device)
