...
class HER2Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if not mut_file_name or mut_file_name == "nan":
            mut_file_name = f"{pdb_id}_{mutate_info.replace(',', '_')}.pdb"
...
def evaluate_model(model, dataloader, device):
    ...
    with torch.no_grad():
        for batch in tqdm(dataloader, desc="Evaluating HER2"):
...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="/home/dataset-local/projects_dir/MERF/data/HER2/HER2_test.csv")
    parser.add_argument("--wt_dir", type=str, default="/home/dataset-local/projects_dir/MERF/data/HER2/PDBs")
    parser.add_argument("--mut_dir", type=str, default="/home/dataset-local/projects_dir/MERF/data/HER2/PDBs_mutated")
    parser.add_argument("--plm_embedding_path", type=str, default="/home/dataset-local/projects_dir/MERF/data/HER2/her2_esm2_650_embeddings.pkl")
    ...
    print("=" * 80)
    print("HER2 Testing Configuration:")
    ...
    results_file = os.path.join(output_dir, f"her2_predictions_epoch{checkpoint_epoch}.csv")
    metrics_file = os.path.join(output_dir, f"her2_metrics_epoch{checkpoint_epoch}.csv")
