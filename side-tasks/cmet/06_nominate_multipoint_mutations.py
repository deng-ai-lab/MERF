#!/usr/bin/env python
"""Nominate CMET 2-point and 3-point mutation combinations from single-mutant model ranks."""
...
def nominate_structure(structure_id: str, args: argparse.Namespace) -> None:
    ...
    singles = best_single_per_position(scored)
    singles["single_source"] = "best_per_position"
